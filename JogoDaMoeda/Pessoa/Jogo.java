...
public class Jogo 
{
  ...
  public void round()
  {
    ...
    for (int i = 0; i < Population.size()/2; i++)
    {
      ...
      Pessoa player_1 = Population.get(random_number_1);
      Pessoa player_2 = Population.get(random_number_2);
      ...
      System.out.println();
      System.out.println(player_1.getClass().getSimpleName() +"_"+ random_number_1 + ": " + play_1);
      System.out.println(player_2.getClass().getSimpleName() +"_"+ random_number_2 + ": " + play_2);
      //System.out.println(player_1.getClass() + random_number_1 +":" + play_1);
      //System.out.println(player_2.getClass() + random_number_2 +":" + play_2);
  ...
  public void showBalance(){
    for (int i = 0; i < qtt; i++)
    {
      ...
      System.out.println("Saldo " + Population.get(i).getClass().getSimpleName() + ": " + Population.get(i).getBalance());
    }
  }
